...
crash_sound = pygame.mixer.Sound(os.path.join(filepath, "assets/sounds/crash.wav"))
...
def game_loop():
    ...
    pygame.mixer.music.load(os.path.join(filepath,"assets/sounds/bgmusic.mp3"))
