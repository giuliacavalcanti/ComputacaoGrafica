...
void Board::timerEvent(QTimerEvent *timer) {
...
void Board::keyPress(QKeyEvent *keyEvent) {
...
void Board::drawLevel(QVector<QRect> blocks) {
...
void Board::drawSnake(QPoint head) {
...
void Board::setUI(QLCDNumber *scoreNumber, QLCDNumber *ateNumber, QLCDNumber *bonusAteNumber, QLCDNumber *lifeNumber,
...
QGraphicsItem* Board::collaps(QGraphicsItem *item){
...
void Board::addGameElement(GameElement gameElement) {
    srand(time(NULL));
...
void Board::removeGameElement(GameElement gameElement) {
...
void Board::showMsg(QString msg) {
