"""
Este módulo implementa objetos básicos (por exemplo, esfera, cubo) 
como conjuntos de vértices e índices que são usados para malhas poligonais.
"""
import math
import numpy as np
...
class Esfera:
    ...
    def __init__(self):
        ...
        divisoes = 180
        d_theta = int(180 / divisoes)
        d_lon = int(360 / divisoes)
