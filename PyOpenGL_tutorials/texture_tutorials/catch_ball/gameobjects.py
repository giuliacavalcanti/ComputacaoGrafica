...
from primitives import Cubo, Esfera, Vidas
...
class EsferaGameObject(Esfera):
    """ Implements OpenGL Esfera object """
    VAO = None
    VBO = None
    EBO = None
...
class LiveVidas(Vidas):
    """ Implements OpenGL Vidas objects (show player's lifes"""
    VAO = None
    VBO = None
    EBO = None
...
class Background(CuboGameObject):
    scale = 11.0
